...
在社群媒體渲染下的 AI 我們所看到的都是以完成任務為導向的，但利用 AI 來輔助學習的成效如何一直都是個很少人提及的，因此想要嘗試看看能不能用 AI 來幫助我學習，以及整個過程的模樣是什麼
</v-click>
...
實驗主要針對那些平常看到覺得有趣但一直都沒認真去理解的事物

<v-click>

以往個人看待這種問題都會以幾種方式被打發掉，之後再遇到類似的問題時，同樣情境再次發生，形成一種惡性循環
